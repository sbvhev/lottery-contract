...
describe("ClaimManagement", function () {
  ...
  before(async () => {
    ...
    const tx = await coverPoolFactory.connect(ownerAccount).createCoverPool(consts.POOL_2, consts.CAT, [consts.ASSET_1, consts.ASSET_2], COLLATERAL, consts.DEPOSIT_RATIO, consts.CM_TIMESTAMPS[0], consts.ALLOWED_EXPIRY_NAMES[0]);
    await tx;
